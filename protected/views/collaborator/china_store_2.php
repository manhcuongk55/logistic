                    ...
                    <table class="table table-bordered admin-table">
                        ...
                        <tbody>
                            <tr ng-repeat="item in sort(items)" ng-init="code = item.delivery_order_code">
                                <td>
                                    <input type="checkbox" ng-model="selectedCodes[code]" ng-disabled="item.status > 4 || codeUpdating[code]" />
                                </td>
                                <td class="">
                                    <div>
                                ...
                                <td>
                                    <input type="text" class="form-control" ng-disabled="item.status > 4" ng-model="item.block_id" />
                                </td>
                                <td>
                                    <input type="number" class="form-control" ng-disabled="item.status > 4" ng-model="item.total_weight" />
                                </td>
                                <td>
                                    <input type="number" class="form-control" ng-disabled="item.status > 4" ng-model="item.total_volume" />
                                </td>
                                <td>
                                    <input type="number" class="form-control" ng-disabled="item.status > 4" ng-model="item.num_block" />
                                </td>
                                <td>
                                    <textarea class="form-control" ng-disabled="item.status > 4" ng-model="item.note"></textarea>
                                </td>
                                <td>
                                    <span></span>
                                </td>
                                ...
                                <td>
                                    <button type="button" class="btn btn-sm btn-primary" ng-disabled="item.status > 4 || codeUpdating[code]" ng-click="updateItem(item.delivery_order_code)">Cập nhật</button>

    ...
    <div class="z-depth-1 pd-a10">
        ...
        <div class="row account-section-title" style="border-top: none">
            <div class="col-md-4 col-md-offset-8 text-right">
                <!-- <input type="number" id="input-purchase-price" class="form-control" ng-disabled="!hasItemSelected()" ng-model="purchasePrice" ng-enter="onPurchasePrice(purchasePrice);" placeholder="Giá mua" /> -->
            </div>
        </div>
        <div>
                    ...
                    <table class="table table-bordered admin-table">
                        ...
                        <tbody>
                            <tr ng-repeat="item in sort(items)" ng-init="code = item.delivery_order_code">
                                ...
                                <td>
                                    <input type="text" class="form-control" ng-disabled="codeStatuses[code]!='success'" readonly="readonly" ng-model="item.block_id" />
                                </td>
                                <td>
                                    <input type="number" class="form-control" ng-disabled="codeStatuses[code]!='success'" readonly="readonly" ng-model="item.total_weight" />
                                </td>
                                <td>
                                    <input type="number" class="form-control" ng-disabled="codeStatuses[code]!='success'" readonly="readonly" ng-model="item.total_volume" />
                                </td>
                                <td>
                                    <input type="number" class="form-control" ng-disabled="codeStatuses[code]!='success'" readonly="readonly" ng-model="item.num_block" />
                                </td>
                                <td>
                                    <textarea class="form-control" ng-disabled="codeStatuses[code]!='success'" readonly="readonly" ng-model="item.note"></textarea>
                                </td>
                                <!-- <td>
                                    <input type="number" class="form-control" ng-disabled="codeStatuses[code]!='success'" ng-model="item.purchase_price" />
                                </td> -->
                                <td>
                                    <span></span>
                                </td>
                                ...
                                <td>
                                    <span ng-bind="item.vietnam_delivery_time | dateTime"></span>
                                </td>
                                <!-- <td>
    ...
    (function(){
        ...
        app.controller("AppController",["$scope","$http","$timeout",function($scope,$http,$timeout){
            ...
            function confirmShopDeliveryOrder(code,callback){
                $http.post("/collaborator/confirm_export_shop_delivery_order?delivery_order_code=" + code).then(function(response){
            ...
            // $scope.onPurchasePrice = function(purchasePrice){

<ul list-pagination class="pagination" data-num-page="<?php echo $pagination->lastPage() ?>">
	<?php if(($pagination->lastPage() > 1) && $pagination->hasCalculated()): ?>
		<?php if($pagination->canFirst()): ?>
			<li><a list-page="<?php echo $pagination->firstPage() ?>" href="<?php echo $pagination->firstUrl() ?>"><i class="fa fa-angle-double-left"></i></a></li>
		<?php endif; ?>
		...
		<?php if($pagination->canLast()): ?>
			<li><a list-page="<?php echo $pagination->lastPage() ?>" href="<?php echo $pagination->lastUrl() ?>"><i class="fa fa-angle-double-right"></i></a></li>
		<?php endif; ?>
	<?php endif; ?>
</ul>
...
abstract class BaseUser extends SModel {
	...
	public function rules() {
		return array(
			...
			array('active, created_time, updated_time, is_email_active, google_id, collaborator_group_id', 'numerical', 'integerOnly'=>true),
			...
			array('active, is_email_active, email_active_token, google_id, google_token, phone, image, image_thumbnail, facebook_id, facebook_access_token, collaborator_group_id, skype, address', 'default', 'setOnEmpty' => true, 'value' => null),
			array('id, active, created_time, updated_time, name, email, password, is_email_active, email_active_token, google_id, google_token, phone, image, image_thumbnail, facebook_id, facebook_access_token, collaborator_group_id, skype, address', 'safe', 'on'=>'search'),
		);
	}

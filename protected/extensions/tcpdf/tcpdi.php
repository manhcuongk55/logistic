...
require_once(__DIR__ . '/../fpdf/vendor/setasign/fpdi/fpdf_tpl.php');
        ...
        foreach($this->_tpls AS $tplidx => $tpl) {
            ...
            if (isset($tpl['resources'])) {
            	...
            	if(isset($this->_res['tpl'][$tplidx]['images']) && count($this->_res['tpl'][$tplidx]['images']) ||
            	   isset($this->_res['tpl'][$tplidx]['_tpls']) && count($this->_res['tpl'][$tplidx]['_tpls']))
            	{
                    $this->_out('/XObject <<');
                    if (isset($this->_res['tpl'][$tplidx]['images']) && count($this->_res['tpl'][$tplidx]['images'])) {
                    ...
                    if (isset($this->_res['tpl'][$tplidx]['_tpls']) && count($this->_res['tpl'][$tplidx]['_tpls'])) {
                        foreach($this->_res['tpl'][$tplidx]['_tpls'] as $i => $tpl)
